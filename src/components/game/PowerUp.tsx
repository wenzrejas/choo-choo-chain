...
const ringInnerGeo = new THREE.RingGeometry(0.78, 0.9, 24);
...
const clockDotMat = new THREE.MeshStandardMaterial({
  color: "#e53935",
  roughness: 1,
  metalness: 0,
});
...
const shieldBossMat = new THREE.MeshStandardMaterial({
  color: "#ffd740",
  roughness: 0.2,
  metalness: 0.85,
});
...
function ClockShape(): JSX.Element {
  return (
    <group>
      ...
      />
      <mesh
        geometry={handShortGeo}
        material={clockHandMat}
        position={[-0.08, 0.16, 0.04]}
      />
      <mesh
        geometry={handLongGeo}
        material={clockHandMat}
        position={[0, 0.16, -0.1]}
      />
      <mesh
        geometry={clockDotGeo}
        material={clockDotMat}
        position={[0, 0.17, 0]}
      />
    </group>
  );
...
function GlowRings({
  ...
  return (
    <group rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.02, 0]}>
      <mesh
        geometry={ringInnerGeo}
        material={mats[matIdx]}
        scale={[innerScale, innerScale, 1]}
      />
      <mesh
        geometry={ringOuterGeo}
        material={mats[matIdx + 1]}
        scale={[outerScale, outerScale, 1]}
      />
    </group>
  );
}
